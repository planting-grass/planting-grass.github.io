...
- [[React] Prop Drilling 이란 무엇이고, 어떻게 해결할 수 있을까?](https://velog.io/@rachel28/Prop-Drilling)

- [React에서 Prop Drilling과 해결 방법](https://slog.website/post/13)

- [[React] 전역 상태관리1(Prop Drilling, 전역상태 관리의 필요성)](https://disco-biscuit.tistory.com/185)
